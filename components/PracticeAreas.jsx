...
const PRACTICE_DATA = [
  {
    ...
    description:
      "We support businesses through every stage of their lifecycle, from establishment to expansion. Our team advises on private equity, M&A, restructuring, and corporate governance, ensuring your business foundation is solid, compliant, and scalable in the Nigerian and global market.",
  },
  {
    id: 2,
    ...
    description:
      "We advise tech companies, digital platforms, and creatives on content rights, licensing, data protection (NDPR/GDPR), and brand partnerships. We bridge the gap between rapid innovation and complex regulation to keep your intellectual assets secure.",
  },
  {
    id: 3,
    ...
    description:
      "Protecting creative and commercial assets is at our core. We handle trademark registration, patent filing, copyright disputes, and licensing strategies. We ensure your brand's value is legally recognized and defended against infringement.",
  },
  // {
  //   id: 4,
  ...
  // },
  {
    ...
    description:
      "We guide employers through drafting contracts, HR policies, and compliance with Nigerian labour laws. We also handle workplace investigations and dispute avoidance strategies to maintain a healthy and legal workforce environment.",
  },
  {
    id: 5,
    ...
    slug: "private-wealth",
    description:
      "We provide discreet, high-level support for high-net-worth individuals and families. Our services include estate planning, wills, trusts, and family law matters, ensuring your legacy is preserved according to your precise wishes.",
  },
  {
    id: 6,
    title: "Corporate Nominee Services",
    slug: "corporate-nominee-services",
    description:
      "We provide support for the establishment and administration of nominee arrangements, coordination of nominee appointments, preparation and maintenance of supporting documentation, and ongoing administrative assistance.",
  },
];
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                We provide commercially sound legal advisory across various
                industries. We don&apos;t just interpret the law; we use it to
                pave the way for your business goals.
              </p>
