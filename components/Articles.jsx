    ...
    <section className="py-24 bg-white border-t border-slate-100">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <span className="text-amber-700 font-bold tracking-widest text-sm uppercase mb-2 block">Insights</span>
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900">Latest Legal Perspectives</h2>
          </div>
          <Link href="/articles">
            <Button variant="link" className="text-slate-900 hover:text-amber-700 p-0 text-lg font-semibold">
              ...
              <div className="py-8 border-b border-slate-200 group-hover:bg-slate-50 transition-colors duration-300">
                <div className="grid md:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="md:col-span-7">
                    <h3 className="text-xl md:text-2xl font-serif font-bold text-slate-900 mb-2 group-hover:text-amber-700 transition-colors">
                      {article.title}
                    </h3>
