    ...
    <footer className="bg-[#3c144c] text-slate-400 py-16 border-t border-white text-sm">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                className="p-2 bg-white text-amber-600 hover:bg-amber-600 hover:text-white transition-colors flex items-center justify-center"
              >
                <Linkedin size={18} />
              </a>
              <a
              ...
              <a
                href="https://www.instagram.com/cegwu_law"
                target="_blank"
                className="p-2 bg-white text-amber-600 hover:bg-amber-600 hover:text-white transition-colors flex items-center justify-center"
              >
                <Instagram size={18} />
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  ...
                  className="hover:text-amber-500 transition-colors"
                >
                  Private Wealth (Family Law, Wills, Tax & Estate Planning)
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="bg-slate-900 border-none outline-none px-4 py-2 w-full text-white placeholder-slate-600"
              />
              <button className="bg-amber-600 text-white px-4 hover:bg-amber-700 transition-colors">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-white pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p>
            &copy; {new Date().getFullYear()} C. Egwu Law Firm. All rights
            reserved.
          </p>
