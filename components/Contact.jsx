...
export const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-[#3c144c] text-white border-t border-slate-900"
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24">
          ...
          {/* Form Side */}
          <div className="bg-[#3c144c] p-8 md:p-10 border border-white">
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-wider text-white">
                      First Name
                    </label>
                    <input
                      name="firstName"
                      ...
                      className="w-full bg-transparent border-b border-white py-2 text-white focus:border-amber-500 focus:outline-none transition-colors rounded-none placeholder-gray-500"
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-transparent border-b border-white py-2 text-white focus:border-amber-500 focus:outline-none transition-colors rounded-none"
                  >
                    ...
                    <option className="bg-slate-900">Employment & Labour Law</option>
                    <option className="bg-slate-900">Private Wealth (Family Law, Wills, Tax & Estate Planning)</option>
                ...
                <div className="space-y-2 pt-4">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-transparent border-b border-white py-2 text-white focus:border-amber-500 focus:outline-none transition-colors rounded-none min-h-[100px] placeholder-gray-500"
