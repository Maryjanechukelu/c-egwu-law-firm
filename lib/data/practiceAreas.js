export const practiceAreas = [
  {
    ...
    title: "Corporate Law",
    shortDescription:
      "Supporting businesses through every stage of their lifecycle, from establishment to expansion.",
    icon: "Briefcase",
    heroImage:
...
decisions that support long-term stability and growth. `,
  },
  {
    ...
    shortDescription:
      "Advising tech companies, digital platforms, and creatives on the legal complexities of the digital economy.",
    icon: "Cpu",
    heroImage:
...
we provide practical guidance that allows clients to innovate and scale safely.`,
  },
  {
    ...
    shortDescription:
      "Protecting creative and commercial assets through strategic IP management.",
    icon: "Scale",
    heroImage:
...
competitive markets.`,
  },
  {
    ...
    shortDescription:
      "Strategic employment law advisory for progressive workplaces.",
    icon: "Users",
    heroImage:
...
Nigerian labour standards.`,
  },
  {
    ...
    shortDescription:
      "Discreet legal support for high-net-worth individuals and families.",
    icon: "ShieldCheck",
    heroImage:
      "https://images.unsplash.com/photo-1554224311-beee4f651465?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
...
preserve family interests, and provide clarity during sensitive transitions.`,
  ...
  {
    id: "Corporate Nominee Services",
    slug: "corporate-nominee-services",
    title: "Corporate Nominee Services",
    shortDescription:
      "Strategic corporate nominee services for businesses and individuals.",
    icon: "ShieldCheck",
    heroImage:
      "https://images.unsplash.com/photo-1554224311-beee4f651465?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    fullDescription: `We provide support for the establishment and administration of nominee arrangements, coordination of nominee appointments, preparation and maintenance of supporting documentation, and ongoing administrative assistance. We work closely with clients and their professional advisers to ensure that nominee structures are properly documented and aligned with their commercial and corporate objectives.
Whether as part of an investment holding structure, corporate reorganisation, or other business arrangement, we provide practical support to facilitate effective corporate administration and governance.
These services are delivered through CEL Corporate Services Ltd, our affiliated corporate services company. CEL Corporate Services Ltd provides company secretarial, corporate nominee, corporate administration, and related business support services to businesses, investors, and corporate groups seeking reliable and professional corporate support solutions.`,
  },
];
